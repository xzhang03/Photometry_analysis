...
varargin_GLMintro = {'Fs', [], 'UseGaussian', true, 'GauSigma', GauSigma,...
    ...
    SpacingBasis, 'CopyJitterN', 3, 'useStep', false};
...
disp(['Deviance explained: ', num2str(Deviance_explained)]);
