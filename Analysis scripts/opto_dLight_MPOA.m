...
tcpZ([inputloadingcell_MPOAdLightNaive;inputloadingcell_MPOAdLightSatiated;...
    inputloadingcell_MPOAdLightShamSatiated],...
...
varargin_viewopto = {'datasets', sets, 'flip_signal', false, 'yrange', [],...
    'heatmaprange', [-1 1], 'showX', [], 'optolength', 50, 'usemedian', false,...
    'keepc', {'order', [1:10]}, 'outputdata', true, 'outputfs', 50, 'datatype', 'trig'};
viewoptostruct(datastruct_MPOAdLightNaive, varargin_viewopto);
...
[datastruct_MPOAdLightSatiated, n_series_MPOAdLightSatiated] =...
    ...
    'externalsigma', [0.10], 'zero_baseline', true, 'zero_baseline_per_session', true,...
    'linearleveling', false, 'useunfiltered', true, 'refilter', Hd, 'checkoptopulses', false,...
    'useinternalsigma', true);
...
varargin_viewopto = {'datasets', [1 3], 'flip_signal', false, 'yrange', [-0.15 0.15],...
    'heatmaprange', [-1 1], 'showX', [], 'optolength', 50, 'usemedian', false,...
    'keepc', {'order', []}, 'outputdata', true, 'outputfs', 50, 'datatype', 'trig'};
viewoptostruct(datastruct_MPOAdLightSatiated, varargin_viewopto);
...
[datastruct_MPOAdLightShamSatiated, n_series_MPOAdLightShamSatiated] =...
    ...
    'externalsigma', [0.07], 'zero_baseline', true, 'zero_baseline_per_session', true,...
    'linearleveling', false, 'useunfiltered', true, 'refilter', Hd, 'checkoptopulses', false,...
    'useinternalsigma', true);
...
viewoptostruct(datastruct_MPOAdLightShamSatiated, varargin_viewopto);