...
varargin_CloseExamDLCstruct = {'datafield','dist','bhvfield', 'CloseExam',...
    'pre_space', 10, 'post_space', 10, 'removenantrials', true, 'nantolerance', 0.2,...
    'logstarttime', true};
...
%% Correlation
corrDLCbhvstruct(CloseExamstruct, CloseExamDLCstruct, {'keepc', {'session', 1}});
